...
//import { Textarea } from 'components/Validation';
...
export default class CodeEditor extends React.Component {
    static propTypes = {
        ...
        highlight: PropTypes.oneOfType([PropTypes.func, PropTypes.elementType]),
    ...
    componentDidUpdate() {
        ...
        this._inputPre.scrollTop = this.state.scrollTop;
    }
    ...
    _handleScroll = () => {
        let scrollTop = this._input.scrollTop;
