#!/usr/bin/env bash
# Based on the CNCjs Installer script from https://raw.githubusercontent.com/cncjs/cncjs-pi-raspbian/
# ===========================================================================
# 
# How-to Use:
...
# 
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
SCRIPT_TITLE="CNCjs AdvancedMacro Widget Installer"
SCRIPT_VERSION=1.0.0
SCRIPT_DATE=$(date -I --date '2020/12/13')
SCRIPT_AUTHOR="Dieter Rosch"
...
echo -e "${COL_BLACK}${SCRIPT_TITLE_FULL}${COL_NC}
    ...
    / \   __| |_   ____ _ _ __   ___ ___  __| |  \/  | __ _  ___ _ __ ___   \ \      / (_) __| | __ _  ___| |_ 
   / _ \ / _` \ \ / / _` | '_ \ / __/ _ \/ _` | |\/| |/ _` |/ __| '__/ _ \   \ \ /\ / /| |/ _` |/ _` |/ _ \ __|
  / ___ \ (_| |\ V / (_| | | | | (_|  __/ (_| | |  | | (_| | (__| | | (_) |   \ V  V / | | (_| | (_| |  __/ |_ 
 /_/   \_\__,_| \_/ \__,_|_| |_|\___\___|\__,_|_|  |_|\__,_|\___|_|  \___/     \_/\_/  |_|\__,_|\__, |\___|\__|
                                                                                                |___/          

  Installing CNCjs AdvancedMacro Widget
   - https://dieterrosch.github.io/cncjs-advancedmacro-widget/v1
   - https://github.com/dieterrosch/cncjs-advancedmacro-widget
...
Press 'ok' to start install of the lastest version of the widget"
...
if [[ ${main_list_entry_selected[*]} =~ 'A05' ]]; then
	...
	declare -A whiptail_list_options=(\
        ...
        [AdvancedMacro Widget]="https://github.com/dieterrosch/cncjs-advancedmacro-widget","YES" \
	  )
